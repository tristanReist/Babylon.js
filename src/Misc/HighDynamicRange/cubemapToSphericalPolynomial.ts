...
export class CubeMapToSphericalPolynomialTools {
     ...
     * @return The Spherical Polynomial data.
     */
    public static ConvertCubeMapTextureToSphericalHarmonics(texture: BaseTexture) {
        if (!texture.isCube) {
            // Only supports cube Textures currently.
            return null;
        }
     ...
     * @return The Spherical Polynomial data.
     */
    public static ConvertCubeMapToSphericalHarmonics(cubeInfo: CubeMapInfo): SphericalHarmonics {
        var sphericalHarmonics = new SphericalHarmonics();
        var totalSolidAngle = 0.0;
